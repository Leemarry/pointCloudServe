...
/**
 * KMZ航线—服务端请求获取无人机当前KMZ航线任务 (#3125)
 */
public class EFLINK_MSG_3125 implements Serializable {

    /**
     * 消息ID
     */
    public final int EFLINK_MSG_ID = 3125;
    /**
     * 内容段数据长度
     */
    ...
    public EFLINK_MSG_3125() {
    }

    public EFLINK_MSG_3125(int tag, int back) {
        Tag = tag;
        Back = back;
    }
