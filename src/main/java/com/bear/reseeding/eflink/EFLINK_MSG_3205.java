...
/**
 * 从无人机获取某个时间断媒体文件(#3205)
 */
public class EFLINK_MSG_3205 implements Serializable {
    public final int EFLINK_MSG_ID = 3205;
    ...
    public EFLINK_MSG_3205(int versionInside, int tag, int storageArea, int mediaType, long startTimestamp, long endTimestamp) {
    ...
    public EFLINK_MSG_3205(byte[] packet) {
        InitPacket(packet, 0);
    }

    public EFLINK_MSG_3205(byte[] packet, int index) {
