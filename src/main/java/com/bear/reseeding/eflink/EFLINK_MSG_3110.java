 ...
 * 航线—下载ACK (#3110)
 */
public class EFLINK_MSG_3110 implements Serializable {

    /**
     * 消息ID
     */
    public final int EFLINK_MSG_ID = 3110;
    /**
     * 内容段数据长度
     */
    ...
    public EFLINK_MSG_3110() {
    }

    public EFLINK_MSG_3110(int tag, int result) {
        Tag = tag;
        Result = result;
    }
