 ...
 * 删除媒体文件(#3209)
 */
public class EFLINK_MSG_3209 implements Serializable {
    public final int EFLINK_MSG_ID = 3209;
    ...
    public EFLINK_MSG_3209() {
    }

    public EFLINK_MSG_3209(int versionInside, int tag) {
    ...
    public EFLINK_MSG_3209(byte[] packet) {
        InitPacket(packet, 0);
    }

    public EFLINK_MSG_3209(byte[] packet, int index) {
