 ...
 * 下载选中的媒体文件(#3206)
 */
public class EFLINK_MSG_3206 implements Serializable {
    public final int EFLINK_MSG_ID = 3206;

    /**
     * 内容段数据长度
     */
    public final int EFLINK_MSG_LENGTH = 3;
    ...
    public EFLINK_MSG_3206() {
    }

    public EFLINK_MSG_3206(int versionInside, int tag, int storageArea) {
        VersionInside = versionInside;
        Tag = tag;
        StorageArea = storageArea;
    }

    public EFLINK_MSG_3206(byte[] packet) {
        InitPacket(packet, 0);
    }

    public EFLINK_MSG_3206(byte[] packet, int index) {
